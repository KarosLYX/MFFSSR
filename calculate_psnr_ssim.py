...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default=r'/home/LYX/Datasets/NTIRE2024/Track1/HR', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default=r'/home/LYX/Model/CVHSSR-main_new/CVHSSR-main/results/CVHSSR-T_4x_all_1M/visualization/NTIRE2024', help='Path to restored images')
